...
void USTUF_GameOverWidget:: NativeOnInitialized()
{
	...
	if (ResetLevelButton)
	{
		ResetLevelButton->OnClicked.AddDynamic(this,&USTUF_GameOverWidget::OnResetLevel);
	}
...
void USTUF_GameOverWidget::OnResetLevel()
{
